...
| Phase 13 | [phase13-deliberative-consensus.md](prds/phase13-deliberative-consensus.md) | ✅ 완료 | MAXS식 multi-round 숙의 합의 |
| Phase 13 Amendment | [phase13-deliberation-acceptance-criteria.md](prds/phase13-deliberation-acceptance-criteria.md) | 📝 초안 | 숙의 변경 수용 기준 강화 |
